      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="?r=participante/create">Participante</a></li>
            <li><a href="?r=evento/admin">Eventos</a></li>
            <li><a href="?r=tipoParticipante/admin">Tipo participante</a></li>
            <li><a href="?r=participantesEvento/admin">Participantes Evento</a></li>
          </ul>
