	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php?r=site/login">Proyecto Revista</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <!--<li><a href="#">Dashboard</a></li>-->
            <?php if(Yii::app()->user->isGuest): ?>
              <li><a href="?r=site/login">Iniciar sesion</a></li>
            <?php else: ?>
              <li><a href="?r=site/logout">salir de sesion</a></li>
            <?php endif; ?>
          </ul>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="?r=indice/create">Indices</a></li>
            <li><a href="?r=autor/admin">Autores</a></li>
            <li><a href="?r=articuloautor/admin">Articulo Autores</a></li>
