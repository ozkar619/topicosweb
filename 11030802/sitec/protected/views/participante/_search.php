...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'idparticipante'); ?>
		<?php echo $form->textField($model,'idparticipante',array('class'=>'form-control')); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'idtipo'); ?>
		<?php echo $form->textField($model,'idtipo',array('class'=>'form-control')); ?>
	</div>
